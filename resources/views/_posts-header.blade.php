            ...
            <x-dropdown>
                <x-slot name="trigger">
                    <button class="py-2 pl-3 pr-9 text-sm font-semibold w-full lg:w-32 text-left flex lg:inline-flex">
                        ...
                        <x-icon name="droparrow" class="absolute pointer-events-none" style="right: 12px;"></x-icon>
                    </button>
                ...
                <x-dropdown-item href="{{ url('/categories/' . $category->slug) }}" :active="isset($currentCategory) && $currentCategory->is($category)">
